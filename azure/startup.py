...
poller = network_client.network_interfaces.begin_create_or_update(RESOURCE_GROUP_NAME,
    NIC_NAME, 
    {
        ...
        "networkSecurityGroup": {
            "id": "/subscriptions/f0514094-5bb5-4925-9323-de8fc229bb63/resourceGroups/backend_group_10101532/providers/Microsoft.Network/networkSecurityGroups/BACK-nsg"
        }
    }
)
...
poller = network_client.network_interfaces.begin_create_or_update(RESOURCE_GROUP_NAME,
    NIC_NAME, 
    {
        ...
        "networkSecurityGroup": {
            "id": "/subscriptions/f0514094-5bb5-4925-9323-de8fc229bb63/resourceGroups/frontend_group_10101527/providers/Microsoft.Network/networkSecurityGroups/FRONT-nsg"
        }
    }
)
...
poller = compute_client.virtual_machines.begin_create_or_update(RESOURCE_GROUP_NAME, VM_NAME,
    {
        ...
        "properties": {
            ...
            "userData": str(base64.b64encode(bytes('#cloud-config\nruncmd:\n - cd /home/thomas/frontend/\n - sed -i \'2s/.*/let back_addr = \"' + str(backend_address.ip_address) + '\";/\'  index.js\n - python3 -m http.server', 'utf-8')))[2:-1]
        }
    }
)
